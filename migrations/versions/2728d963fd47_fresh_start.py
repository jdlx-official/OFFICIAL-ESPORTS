...
Revision ID: 2728d963fd47
Revises: 
Create Date: 2025-10-09 07:41:13.221952
...
def upgrade():
    ...
    sa.Column('entry_fee', sa.String(length=50), nullable=True),
    sa.Column('prize_pool', sa.String(length=50), nullable=True),
